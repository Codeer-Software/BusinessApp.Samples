    ...
    TimeProvider timeProvider)
{
    ...
    /// CLB 本来の削除が失敗して<b>削除なのに「入力内容を確かめ…」の定型文</b>が出る（2026-09-10 実測 1.3.20。qa/01 F-41）。
    ...
    /// （2026-09-10 実測 1.3.20。qa/01 F-41。<c>MultiTypeValue</c> に整数専用の型は無い）。数値の欄で来ても読む。</para>
    ...
    /// 保存済みの親なら数値の字面、新しい伝票なら親と同じ仮 ID（2026-09-10 実測 1.3.20。qa/01 F-41）。
