...
/// （<c>MasterSubmitGate</c> のコード、<c>CompanyProfileSubmitGate</c> の決算月）。
/// <b>ここで NULL に寄せた値が <c>NOT NULL</c> の列に当たると定型文になる</b>ので、
/// <b>必須の欄を増やしたら、その欄を断る関門も対で置く</b>（2026-09-09 の自己レビュー）。</para>
