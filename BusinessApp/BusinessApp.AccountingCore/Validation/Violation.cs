...
/// <summary>
/// 検証で見つかった違反。<see cref="Code"/> は docs/04 §1 の不変条件番号（例 <c>I-01</c>）か、
/// それに紐づかない入力検査の識別子を持つ。画面はコードで分岐し、文言は表示にだけ使う。
/// </summary>
...
/// <summary>違反の識別子。docs/04 §1 の不変条件と 1 対 1 に対応するものは番号をそのまま使う。</summary>
