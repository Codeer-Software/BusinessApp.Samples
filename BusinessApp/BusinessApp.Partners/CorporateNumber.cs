...
/// </summary>
/// <remarks>
/// <para><b>13 桁は「1 桁の検査用数字 ＋ 12 桁の基礎番号」</b>である（番号法令 35 ①）。
/// 算式と計算例はリサーチに引いてある
...
public static class CorporateNumber
{
    ...
    /// <b>確かめる先を公表サイトだけにしない</b>——人格のない社団等は、代表者が同意したときだけ公表される
    /// （docs/research/2026-08-25_取引先の識別番号と公表システム.md §1。docs/21 §2-3「どこで確かめるかも言う」）。
    /// </remarks>
    public static readonly string CheckDigitDescription =
        $"「{Label}」が正しくありません。打ち間違いの可能性があります。"
