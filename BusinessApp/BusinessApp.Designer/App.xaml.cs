...
namespace BusinessApp.Designer
{
    public partial class App : DesignerApp
    {
        ...
        {
            //load dll.
            typeof(BusinessApp.Client.Shared.Services.AppInfoService).ToString();
            ...
            BlazorRuntime.InstallBundleCss("BusinessApp.Client.Shared");

            base.OnStartup(e);

            MainWindow.Title = "BusinessApp";
