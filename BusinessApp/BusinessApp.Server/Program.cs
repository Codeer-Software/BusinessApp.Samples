using BusinessApp.Client.Shared.Samples;
using BusinessApp.Server;
...
SystemConfig.Instance.AISettings = builder.Configuration.GetSection("AISettings").Get<AppAISettings>() ?? new();
