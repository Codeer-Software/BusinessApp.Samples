...
using static AccountingApp.Designer.Lib.AI.DbDefinitionServiceExtensions;
...
namespace AccountingApp.Designer.Lib.AI
{
    public class ExecuteSqlChat : IAIChat
    {
        ...
        public ExecuteSqlChat(IDesignerChatHost host, AISettings settings, IExecuteSqlEditor editor)
        {
