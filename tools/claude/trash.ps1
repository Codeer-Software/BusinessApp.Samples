...
.DESCRIPTION
    ...
    だから開発者の確認を待たずに実行してよい。規則は docs/33_失わないためのルール.md §1、
...
function Invoke-SelfTest {
    ...
    try {
        ...
        # コミットのたびに開発者のごみ箱が汚れる。docs/33 §1 の規則は Claude が打つコマンドを縛るもので、
