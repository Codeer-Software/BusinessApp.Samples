...
使い方:
    python Designer/tools/check_db_dangling.py                 # 既定の DB を検査
    python Designer/tools/check_db_dangling.py <path/to.db>    # DB を指定
...
# 既定の DB（LocalData/db/business-app_v1.db）。このファイルは Designer/tools/ にある
_HERE = os.path.dirname(os.path.abspath(__file__))
DEFAULT_DB = os.path.abspath(
    os.path.join(_HERE, os.pardir, os.pardir, 'LocalData', 'db', 'business-app_v1.db'))
